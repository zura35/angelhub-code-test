...
export default function InvestmentOpportunityCard({
    ...
    return (
        <div key={`invt-op-card-${id}`} className="flex flex-col relative col-span-1 min-w-invt-op-cover max-w-invt-op-cover min-h-invt-op-cover max-h-invt-op-cover my-6 mr-2 lg:mx-2 shadow-lg">
